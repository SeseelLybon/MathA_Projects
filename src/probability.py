...
def chances(throw):
    ...
    if State.full_house not in states:
        ...
        # contains a b c d e
        # needs 2a && b
        # p(a) and p(a) and p(b) = (3/6)*(3/6)*(2/6)*(1/6)
        # roll c d e
        if len( cntr.values()) == 5:
            print("\t\t a b c d e -> c d e")
            print("\t\t 3:", ftpt( (3/6)*(3/6)*(2/6)*(1/6) ))
    ...
    if State.long_straight not in states:
        ...
        # needs c %% d %% e
        # p(c) and p(d) and p(e) = (3/6)*(2/6)*(1/6)
        # roll 2a 1b
